...
class RedshiftToS3Extractor(BaseExtractor):
    operator_class = Type[RedshiftToS3Transfer]
    operator: RedshiftToS3Transfer

    def __init__(self, operator: RedshiftToS3Transfer):
    ...
    def extract(self) -> StepMetadata:
        ...
        output = Dataset.from_table_schema(
            source=Source(
